		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#flexiblecollayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"flexiblecollayout-display": {
								"semanticObject": "flexiblecollayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=flexiblecollayout",
									"url": sap.ui.require.toUrl("flexiblecollayout")
								}
							}
						}
					}
